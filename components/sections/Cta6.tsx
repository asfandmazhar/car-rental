          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-5">
                ...
                <h4 className="mb-4 neutral-1000 wow heading-4 fadeInUp">
                  How It Works
                </h4>
                  ...
                  <div className="row align-items-center">
                    <div className="col-sm-6">
                      <img
                        ...
                        src="/assets/imgs/banners/main-page-4-images/1.jpg"
                        alt="Carento"
                      />
                      <img
                        className="bdrd8 w-100 mb-15 wow fadeInUp"
                        src="/assets/imgs/banners/main-page-4-images/2.jpg"
                        alt="Carento"
                      />
                    </div>
                    <div className="col-sm-6 mt-md-50">
                      <img
                        className="bdrd8 w-100 mb-15 wow fadeInUp"
                        src="/assets/imgs/banners/main-page-4-images/3.jpg"
                        alt="Carento"
                      />
                      <img
                        className="bdrd8 w-100 wow fadeInUp"
                        src="/assets/imgs/banners/main-page-4-images/4.jpg"
                        alt="Carento"
                      />
                    </div>
                  </div>
