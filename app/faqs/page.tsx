          ...
          <section className="box-section background-2 py-96">
            <div className="container">
              <div className="text-center  mb-40">
                ...
                <h3 className="my-3 heading-3 neutral-1000">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        ...
                        <p className="text-xs-medium neutral-500">
                          Call or contact our support team to make reservations, modify existing bookings, or plan large fleet trips.
                        </p>
                      </div>
                  ...
                  <div className="card-contact">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        ...
                        <p className="text-xs-medium neutral-500">
                          Contact our sales team for corporate collaborations, long-term contracts, or large fleet scheduling.
                        </p>
                      </div>
                      <div className="card-method-contact">
                        <Link className="email text-md-bold" href="#">
                  ...
                  <div className="card-contact">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        ...
                        <p className="text-xs-medium neutral-500">
                          Contact us to explore Luxentina’s operations, branch locations, and service coverage across Spain.
                        </p>
                      </div>
                      <div className="card-method-contact">
                        <Link className="email text-md-bold" href="#">
                  ...
                  <div className="card-contact">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        ...
                        <p className="text-xs-medium neutral-500">
                          Cancel or reschedule bookings easily; full or partial refunds available according to our booking policies.
                        </p>
                      </div>
                      <div className="card-method-contact">
                        <Link className="email text-md-bold" href="#">
                  ...
                  <div className="card-contact">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        ...
                        <p className="text-xs-medium neutral-500">
                          Our technical team is ready to help with login issues, booking glitches, or payment errors.
                        </p>
                      </div>
                      <div className="card-method-contact">
                        <Link className="email text-md-bold" href="#">
                  ...
                  <div className="card-contact">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        ...
                        <p className="text-xs-medium neutral-500">
                          Check our terms of service, privacy policy, and fleet usage rules for safe and reliable trips.
                        </p>
                      </div>
                      <div className="card-method-contact">
                        <Link className="email text-md-bold" href="#">
                  ...
                  <div className="card-contact">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        ...
                        <p className="text-xs-medium neutral-500">
                          All vehicles are insured, drivers are verified, and safety protocols are followed on every trip.
                        </p>
                      </div>
                      <div className="card-method-contact">
                        <Link className="email text-md-bold" href="#">
                ...
                <div className="col-lg-6">
                  <div className="accordion">
                    <div className="mb-2 card border">
                      <div className="px-0 card-header border-0 bg-gradient-1 background-card">
                        ...
                        >
                          <p className="text-lg-bold neutral-1000 pe-4">
                            How do I book a car for personal or corporate use?
                          </p>
                      ...
                      >
                        <p className="pt-0 pb-4 card-body background-body">
                          You can easily book a car through our Luxentina
                          website. Select the type of vehicle your pick-up and
                          drop-off locations, dates. For corporate accounts, you
                          can also manage multiple users under one account for
                    ...
                    <div className="mb-2 card border">
                      ...
                      >
                        <p className="pt-0 pb-4 card-body background-body">
                          Yes! Luxentina allows booking multiple vehicles in a
                          single reservation. Simply select the number of cars
                          you need and the corresponding details for each
                          vehicle during the booking process. This is ideal for
                          corporate events, tours, or group travel.
                        </p>
                      </div>
                    </div>
                    <div className="mb-2 card border">
                      ...
                      >
                        <p className="pt-0 pb-4 card-body background-body">
                          Our fleet includes a variety of options to suit every
                          need: Sedans and luxury cars for business or personal
                          travel SUVs for family trips or group travel Minivans
                          and buses for large groups or corporate events
                          Chauffeur-driven vehicles for VIP services All
                          vehicles are regularly maintained, insured, and
                    ...
                    <div className="mb-2 card border">
                      ...
                      >
                        <p className="pt-0 pb-4 card-body background-body">
                          Yes, bookings can be modified or canceled up to 24
                          hours before the scheduled pick-up. You can easily
                          manage changes through your Luxentina account. For
                          cancellations, our flexible policy ensures you are
                          only charged according to the terms of your booking.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-lg-6 mt-lg-0 mt-2">
                  <div className="accordion">
                    <div className="mb-2 card border">
                      ...
                      <div
                        id="collapseSevent"
                        className={`collapse ${isAccordion == 8 ? "show" : ""} `}
                        data-bs-parent=".accordion"
                      >
                        <p className="pt-0 pb-4 card-body background-body">
                          Absolutely! Luxentina provides professional, licensed
                          chauffeurs for all types of vehicles. You can choose a
                          self-drive option or a chauffeur service during the
                          booking process, depending on your preference.
                        </p>
                      </div>
                    </div>
                    <div className="mb-2 card border">
                      <div className="px-0 card-header border-0 bg-gradient-1 background-card">
                        ...
                        >
                          <p className="text-lg-bold neutral-1000 pe-4">
                            Is Luxentina available across all cities in Spain?
                          </p>
                          <span className="ms-auto arrow me-2">
                            <svg
                              className="invert"
                      ...
                      <div
                        id="collapseEight"
                        className={`collapse ${isAccordion == 9 ? "show" : ""} `}
                        data-bs-parent=".accordion"
                      >
                        <p className="pt-0 pb-4 card-body background-body">
                          Currently, Luxentina operates in all major cities
                          across Spain, including Barcelona, Madrid, Valencia,
                          and Seville. We are continuously expanding our fleet
                          coverage to ensure our clients can book anywhere in
                          Spain with ease.
                        </p>
                      </div>
                    </div>
                    <div className="mb-2 card border">
                      <div className="px-0 card-header border-0 bg-gradient-1 background-card">
                        ...
                        >
                          <p className="text-lg-bold neutral-1000 pe-4">
                            How early should I make a booking for large fleets?
                          </p>
                          <span className="ms-auto arrow me-2">
                            <svg
                              className="invert"
                      ...
                      <div
                        id="collapseNine"
                        className={`collapse ${isAccordion == 10 ? "show" : ""} `}
                        data-bs-parent=".accordion"
                      >
                        <p className="pt-0 pb-4 card-body background-body">
                          For large fleet bookings, we recommend making your
                          reservation at least 1 week in advance. This allows us
                          to allocate the best vehicles, drivers, and ensure
                          availability for your specific dates and requirements.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion">
                    <div className="mb-2 card border rounded-3">
                      <div className="px-0 card-header border-0 bacground-body">
                        ...
                        >
                          <p className="text-lg-bold neutral-1000 pe-4">
                            What payment methods does Luxentina accept?
                          </p>
                          <span className="ms-auto arrow me-2">
                            <svg
                              className="invert"
                      ...
                      >
                        <p className="pt-0 pb-4 card-body">
                          ...
                          secure Stripe payment gateway. Payments via digital
                          wallets like Apple Pay and Google Pay are also
                    ...
                    <div className="mb-2 card border rounded-3">
                      <div className="px-0 card-header border-0 bacground-body">
                        ...
                        >
                          <p className="text-lg-bold neutral-1000 pe-4">
                            Is it safe to pay online on Luxentina?
                          </p>
                          <span className="ms-auto arrow me-2">
                            <svg
                              className="invert"
                      ...
                      >
                        <p className="pt-0 pb-4 card-body">
                          Yes! All online payments are processed securely via
                          Stripe, a globally trusted payment platform. Your card
                          information is encrypted, and Luxentina never stores
                    ...
                    <div className="mb-2 card border rounded-3">
                      <div className="px-0 card-header border-0 bacground-body">
                        ...
                        >
                          <p className="text-lg-bold neutral-1000 pe-4">
                            Can I pay in installments or split the payment?
                          </p>
                          <span className="ms-auto arrow me-2">
                            <svg
                              className="invert"
                      ...
                      >
                        <p className="pt-0 pb-4 card-body">
                          Currently, we require full payment at the time of
                          booking for personal and corporate services. For large
                          fleet bookings, please contact our sales team to
                          discuss customized payment plans or invoicing options.
                        </p>
                      </div>
                    </div>
                    <div className="mb-2 card border rounded-3">
                      ...
                      >
                        <p className="pt-0 pb-4 card-body">
                          Your card is charged immediately when you confirm the
                          booking online. For corporate bookings with invoicing,
                          payments may be processed according to your agreed
                          terms.
                        </p>
                      </div>
                    </div>
                    <div className="mb-2 card border rounded-3">
                      ...
                      >
                        <p className="pt-0 pb-4 card-body">
                          Yes! After completing your booking, Luxentina
                          automatically sends a receipt to your registered
                          email. For corporate clients, we can provide a
                          detailed invoice upon request for accounting purposes.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-lg-6 mt-lg-0 mt-2">
                  <div className="accordion">
                    <div className="mb-2 card border rounded-3">
                      ...
                      >
                        <p className="pt-0 pb-4 card-body">
                          If your payment does not go through, the booking will
                          not be confirmed. You will receive a notification to
                          retry using the same card or a different payment
                          method. For assistance, our support team is available
                          to guide you.
                        </p>
                      </div>
                    </div>
                    <div className="mb-2 card border rounded-3">
                      ...
                      >
                        <p className="pt-0 pb-4 card-body">
                          Currently, each booking can be paid using a single
                          payment method. If you need to split payments, please
                          contact our customer support to arrange a special
                          solution.
                        </p>
                      </div>
                    </div>
                    <div className="mb-2 card border rounded-3">
                      <div className="px-0 card-header border-0 bacground-body">
                        ...
                        >
                          <p className="text-lg-bold neutral-1000 pe-4">
                            Are there any extra charges or taxes?
                          </p>
                          <span className="ms-auto arrow me-2">
                            <svg
                              className="invert"
                      ...
                      >
                        <p className="pt-0 pb-4 card-body">
                          All prices shown on the website include standard
                          taxes. Additional fees, such as tolls or driver
                          gratuity, are separate and will be communicated
                          clearly before your booking confirmation.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="d-flex align-items-center justify-content-around flex-wrap">
                      <div className="mb-4 mb-lg-0 d-block px-lg-5 px-3">
                        ...
                        <div className="text-md-start text-center">
                          <p className="text-lg-bold neutral-1000">Cities in </p>
                          <p className="text-lg-bold neutral-1000">Spain</p>
                        </div>
                      </div>
                      <div className="mb-4 mb-lg-0 d-block px-lg-5 px-3">
                        <div className="d-flex justify-content-center justify-content-md-start">
