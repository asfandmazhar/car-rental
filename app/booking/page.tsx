...
export default function Booking() {
  ...
  return (
    <Layout footerStyle={1}>
      <div className="container container-fluid py-5 bg-light min-vh-100">
        <h2 className="fw-bold text-uppercase">Transfer Booking</h2>
        <hr className="mb-4" />
                          ...
                          <div className="d-flex align-items-center">
                            ...
                            <div className="ms-3 flex-grow-1">
                              ...
                              <small className="text-muted">
                                ...
                                | <BsSuitcase2Fill /> {car.suitcaseCapacity}{" "}
                                Bags
                              </small>
                            </div>
                      ...
                      >
                        <div className="d-flex justify-content-between align-items-start">
                          <div>
                            ...
                            >
                              Prepayment for car booking 10% by card. The rest
                              is paid in cash to the driver.
                            </span>
                          </div>
